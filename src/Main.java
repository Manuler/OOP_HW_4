...
public class Main {
    public static void main(String[] args) {
        ...
        team1.addWarriorToTeam(new Swordman("Boromir", 250, new Sword(25)))
        .addWarriorToTeam(new Swordman("Aragorn", 200, new Sword(50), new Buckler(50, 100)));
        ...
        team2.addWarriorToTeam(new Archer("Frodo", 50, new Bow(20, 20)))
        .addWarriorToTeam(new Archer("Legolas", 200, new Bow(75, 70)));
